...
impl PowerHistory {
  ...
  pub fn update(&mut self, readings: &PowerReadings) {
      ...
      for (channel_history, reading) in &mut [(a0, readings.a0), (a1, readings.a1), (a2, readings.a2), (a3, readings.a3)] {
...
fn set_latest_readings(data: web::Data<RwLock<PowerHistory>>, new_readings: web::Json<PowerReadings>, _req: HttpRequest) -> HttpResponse {
